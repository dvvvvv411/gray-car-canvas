...
export default function ServiceCarouselCard({
  ...
  return (
    <div className="relative group bg-card/40 backdrop-blur-sm border border-border/30 rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] animate-fade-in h-[500px]">
      {/* Glow Effect */}
        ...
        <div className="md:w-1/2 p-6 md:p-8 flex flex-col justify-between">
          ...
          <div className="space-y-3">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-2 h-2 bg-primary rounded-full group-hover/feature:scale-125 transition-transform duration-300"></div>
