      ...
      <section className="bg-muted/30 py-16 px-4">
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 items-stretch">
            <div className="bg-background p-8 rounded-2xl shadow-xl border border-border flex flex-col">
              <div className="inline-flex items-center gap-2 bg-primary/10 backdrop-blur-sm px-4 py-2 rounded-full border border-primary/20 mb-6 w-fit">
