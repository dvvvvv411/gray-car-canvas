	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow-pulse': {
					'0%, 100%': {
						boxShadow: '0 0 20px hsl(20 100% 50% / 0.4)'
					},
					'50%': {
						boxShadow: '0 0 40px hsl(20 100% 50% / 0.8)'
					}
				},
				'text-glow': {
					'0%, 100%': {
						textShadow: '0 0 10px hsl(20 100% 50% / 0.6)'
					},
					'50%': {
			...
			animation: {
				...
				'section-fade': 'section-fade 1s cubic-bezier(0.16, 1, 0.3, 1)',
